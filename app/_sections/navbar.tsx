...
const HamburgerLogo = () => {
    ...
    <rect x="21.1" y="16.8999" width="19.7" height="1.3" rx="0.65" transform="rotate(-180 21.1 16.8999)" stroke="#A76ACF" stroke-opacity="0.25"/>
    <rect x="21.6" y="2.44971" width="20.7" height="2.3" rx="1.15" transform="rotate(-180 21.6 2.44971)" fill="black"/>
    <rect x="21.1" y="1.94971" width="19.7" height="1.3" rx="0.65" transform="rotate(-180 21.1 1.94971)" stroke="#A76ACF" stroke-opacity="0.25"/>
    <rect x="21.6" y="9.34961" width="16.1" height="2.3" rx="1.15" transform="rotate(-180 21.6 9.34961)" fill="black"/>
    <rect x="21.1" y="8.84961" width="15.1" height="1.3" rx="0.65" transform="rotate(-180 21.1 8.84961)" stroke="#A76ACF" stroke-opacity="0.25"/>
    </svg>    
}
...
export const Navbar = () => {
    ...
    return <>
        <SideBar open={open}/>
        <div className="w-full bg-white py-6 px-[5%] md:px-[10%] z-30 relative">
